...
- Limpieza y transformación de datos utilizando Pandas y NumPy.
- Consolidación de información proveniente de diferentes fuentes.
- Generación de indicadores y reportes para análisis técnico.
- Procesamiento de información relacionada con alarmas, potencia óptica, atenuación y degradación.
- Generación de información para análisis diarios, semanales y mensuales.
...
- Extracción de información específica a partir de archivos recibidos.
- Organización y estructuración de los datos en Excel.
- Preparación de información correspondiente a los periodos requeridos.
- Automatización de tareas repetitivas para facilitar la consulta y gestión de información.
- Procesamiento y análisis de información histórica de ventas.
- Apoyo en la visualización y análisis de datos mediante Power BI.
